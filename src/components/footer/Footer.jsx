                ...
                <div className='container max-w-[1280px] flex flex-col'>
                    <div className='flex items-center gap-[113px]'>
                        <div className='flex flex-col w-[21%] gap-[25px]'>
                            ...
                            <div className=''>
                                <p className='leading-[22px] text-[rgb(96,96,96)]'>We have clothes that suits your style and which you’re proud to wear. From women to men.</p>
                            </div>
                        ...
                        <div className='flex gap-[113px]'>
                            <div className='flex flex-col gap-[25px]'>
                                <p className='font-medium text-[16px] font-[Satoshi]'>COMPANY</p>
                            ...
                            <div className='flex flex-col gap-[25px]'>
                                <p className='font-medium text-[16px] font-[Satoshi] '>HELP</p>
                                <ul className='flex flex-col gap-[20px]'>
                            ...
                            <div className='flex flex-col gap-[25px]'>
                                <p className='font-medium text-[16px] font-[Satoshi]'>FAQ</p>
                                <ul className='flex flex-col gap-[20px]'>
                                    <li>Account</li>
                            ...
                            <div className='flex flex-col gap-[25px]'>
                                <p className='font-medium text-[16px] font-[Satoshi]'>RESOURCES</p>
                                <ul className='flex flex-col gap-[20px]'>
                                    <li>Free eBooks</li>
                    ...
                    <div className='mt-[50px] flex flex-col gap-[20px]'>
                        ...
                        <div className='flex items-center justify-between'>
                            <div className='flex'>
                                <p className='text-[14px] text-[rgb(96,96,96)] '>Shop.co © 2000-2023, All Rights Reserved</p>
                            </div>
