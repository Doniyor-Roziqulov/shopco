                        ...
                        <div className="border rounded-[20px] px-[32px] py-[28px] flex flex-col gap-[18px]">
                            ...
                            <div className="flex">
                                <p className="leading-[22px] text-[rgb(97,96,96)]">
                                    ...
                                    style used to be a challenge until I
                                    discovered Shop.co. The range of options
                                    they offer is truly remarkable, catering to
                                    a variety of tastes and occasions.”
                                </p>
                            </div>
                        </div>
                    </SwiperSlide>
                        ...
                        <div className="border rounded-[20px] px-[32px] py-[28px] flex flex-col gap-[18px]">
                            ...
                            <div className="flex">
                                <p className="leading-[22px] text-[rgb(97,96,96)]">
                                    ...
                                    stumbled upon Shop.co. The selection of
                                    clothes is not only diverse but also
